...
<div class="flex-content p-4">
    <ul class="nav nav-tabs mb-3">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#requests" data-target="requests">Requests <span id="request-badge"
                    ...
                    <div class="row align-items-center" style="border-bottom: 0.05em solid var(--primary-darker);">
                        <div class="col d-flex align-items-center">
                            ...
                            <div data-sender-username="${request.getSender().getUsername()}">
                                <h5><a class="profile-link" data-bs-toggle="modal"
                                       data-bs-target="#friend-profile-${loop.index}">${request.getSender().getUsername()}</a>
                                </h5>
                            </div>
                        </div>
                        ...
                        <div class="col" style="transform: scale(0.7);">
                            ...
                            <button class="btn btn-primary pull-right" name="decision" value="accept"
                                    data-sender="${request.getSender().getUsername()}" style="margin-bottom: 0.2em">
                                Accept Request
                            </button>
                            <br/>
